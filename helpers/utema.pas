...
uses
  Classes, SysUtils, Graphics, BCButton, BCTypes;

{ Funções de Conversão de HTML To Color }
// https://delphi.cjcsoft.net/viewthread.php?tid=43666
{-------------------------------------- }
...
type
  ...
  TTema = class
    ...
    public
      ...
      procedure SetBcButtonStyle(Button: TBCButton);
...
function TTema.TranslateColorName(Name: String): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TTema.HTMLToColor(const HTML: String): Integer;
var
  Offset: Integer;
begin
  try
...
function TTema.ColorToHTML(Color: TColor): String;
var
...
begin
  FBorderColor := HTMLToColor('#2F0505');
end;
...
procedure TTema.SetBcButtonStyle(Button: TBCButton);
begin
